...
const Home = () => {
  return (
    <div className="h-screen w-screen bg-black flex items-center justify-center">
      <div className="w-[80%] h-[80%] rounded-lg bg-[#ffffff25] flex flex-col items-center justify-center max-md:px-7">
        <Reveal>
        ...
        <RevealLeft>
          <p className="pointer-events-auto leading-relaxed md:leading-relaxed max-w-xl text-sm text-zinc-300 md:text-base max-md:text-center">
